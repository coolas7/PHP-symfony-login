 ...
 */
class Version20180420063938 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX pass ON users');
        $this->addSql('DROP INDEX UNIQ_1 ON users');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX pass ON users (pass)');
        $this->addSql('CREATE FULLTEXT INDEX UNIQ_1 ON users (email)');
    }
}
